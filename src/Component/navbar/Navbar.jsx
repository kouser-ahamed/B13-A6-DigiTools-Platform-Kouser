  ...
  return (
    <nav className="w-full max-w-10/12 mx-auto flex items-center justify-between px-4 sm:px-6 md:px-10 py-4 md:py-5 border-b border-gray-100 bg-white relative">
      ...
      <div className="flex items-center gap-3 sm:gap-4 md:gap-5">
        ...
        {/* Get Started Button */}
        <button className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-full font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-105">
          Get Started
        </button>
      </div>
